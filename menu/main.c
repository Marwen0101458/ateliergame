...
//INIT CAS D'ERREURS
    ...
    Mix_Music *music;
    music=Mix_LoadMUS("/home/marwan/Desktop/projet/mainmenu.mp3");
...
// son lors du click
    ...
    Mix_Chunk *son;
    son = Mix_LoadWAV("/home/marwan/Desktop/projet/mouseclick.wav");
...
//VERIF
    ...
    imageDeFond1 = IMG_Load("/home/marwan/Desktop/projet/intro/frame_000_delay-0.05s.png"); //background1
    imageDeFond = IMG_Load("/home/marwan/Desktop/projet/background.png"); //background
...
//MENU BUTTONS 
    ...
    image1 = IMG_Load("/home/marwan/Desktop/projet/play.png");
    SDL_BlitSurface(image1, &positionFond, ecran, &positionimage1);


    image2 = IMG_Load("/home/marwan/Desktop/projet/settings.png");

    SDL_BlitSurface(image2,&positionFond, ecran, &positionimage2);


    image3 = IMG_Load("/home/marwan/Desktop/projet/quit.png");

    SDL_BlitSurface(image3,&positionFond,ecran,&positionimage3);

    image1a = IMG_Load("/home/marwan/Desktop/projet/play1.png");

    SDL_BlitSurface(image1a,&positionFond,ecran,&positionimage1a);

    image2a = IMG_Load("/home/marwan/Desktop/projet/settings1.png");

    SDL_BlitSurface(image2a,&positionFond,ecran,&positionimage2a);


    image3a = IMG_Load("/home/marwan/Desktop/projet/quit1.png");

    SDL_BlitSurface(image3a,&positionFond,ecran,&positionimage3a);

    image6 = IMG_Load("/home/marwan/Desktop/projet/image6.png"); // option background

    image5 = IMG_Load("/home/marwan/Desktop/projet/image5.png"); // game


    image10=IMG_Load("/home/marwan/Desktop/projet/image10.png"); //back to main menu

    image12=IMG_Load("/home/marwan/Desktop/projet/image12.png"); // full screen

    image13=IMG_Load("/home/marwan/Desktop/projet/image13.png"); //reduced screen

    image14=IMG_Load("/home/marwan/Desktop/projet/image14.png"); // volume -

    image15=IMG_Load("/home/marwan/Desktop/projet/image15.png");

    image16=IMG_Load("/home/marwan/Desktop/projet/image16.png"); //volume +

    image10a=IMG_Load("/home/marwan/Desktop/projet/image10a.png");

    image12a=IMG_Load("/home/marwan/Desktop/projet/image12a.png"); //fscreen selectionné

    image13a=IMG_Load("/home/marwan/Desktop/projet/image13a.png"); // rscreen selectionné

    image14a=IMG_Load("/home/marwan/Desktop/projet/image14a.png");

    image15a=IMG_Load("/home/marwan/Desktop/projet/image15a.png");

    image16a=IMG_Load("/home/marwan/Desktop/projet/image16a.png");
...
while (c<18) 
	...
	if(c<18)
	{
	sprintf(intro,"/home/marwan/Desktop/projet/intro/frame_00%_delay-0.05s.png",c);
	SDL_Delay(50);
...
//animation
	...
	counterr++;
                ...
                police=TTF_OpenFont("/home/marwan/Desktop/projet/font.ttf",50);
                title=TTF_RenderText_Solid(police,"clash of berberiens ",red);
...
//ANIMATION 
            ...
            if(k==1)						// menu play selectionée
            {
                ...
                SDL_Color red= {255,255,255};
                TTF_Font *police=NULL;
                police=TTF_OpenFont("/home/marwan/Desktop/projet/font.ttf",30);
